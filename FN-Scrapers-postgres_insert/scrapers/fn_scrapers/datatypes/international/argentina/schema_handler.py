...
class ARGENTINABill(DocumentItem):
    """
    Object representing an ARGENTINA Bill document scraped from ARGENTINA bills website.
    """
    schema_dir = os.path.dirname(os.path.abspath(__file__)) + os.sep + 'schemas'
    schema_file_path = schema_dir + os.sep + 'doc_schema.json'
    with open(schema_file_path) as fp:
    ...
    def add_file_number(self, file_number):
        self[u'file_number'] = file_number

    def add_journal_number(self, journal_number):
        self[u'journal_number'] = journal_number
