...
class NIGERIABill(DocumentItem):
    """
    Object representing an Nigeria Bill document scraped from Peru bills website.
    """
    schema_dir = os.path.dirname(os.path.abspath(__file__)) + os.sep + 'schemas'
    schema_file_path = schema_dir + os.sep + 'doc_schema.json'
    with open(schema_file_path) as fp:
    ...
    def add_parliament(self, parliament):
        self[u'parliament'] = parliament
