...
class DocumentItem(JsonSchemaItem):
    ...
    schema_file_path = schema_dir + os.sep + 'eu_prep_act_leg.json'
...
class EU_Prep_Leg(DocumentItem):
    """
    Object representing an EU Bill document scraped from Peru bills website.
    """
    schema_dir = os.path.dirname(os.path.abspath(__file__)) + os.sep + 'schemas'
    schema_file_path = schema_dir + os.sep + 'eu_prep_act_leg.json'
    with open(schema_file_path) as fp:
    ...
    def add_celex(self, celex):
        self[u'celex'] = celex

    def add_source_type(self, source_type):
        self[u'source_type'] = source_type

    def add_title(self, title):
        self[u'title'] = title

    def add_document_reference_id(self, document_reference_id):
        self[u'document_reference_id'] = document_reference_id

    def add_authors(self, authors):
        self[u'authors'] = authors

    def add_file_type(self, file_type):
        self[u'file_type'] = file_type

    def add_publication_date(self, publication_date):
        self[u'publication_date'] = publication_date

    def add_eurovoc_descriptors(self, eurovoc_descriptors):
        self[u'eurovoc_descriptors'] = eurovoc_descriptors
    ...
    def add_procedure_title(self, procedure_title):
        self[u'procedure_title'] = procedure_title
