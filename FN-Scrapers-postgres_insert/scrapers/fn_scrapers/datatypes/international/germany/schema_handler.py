...
class GERMANYBill(DocumentItem):
    """
    ...
    def add_printed_copy_number(self, printed_copy_number):
        self[u'printed_copy_number'] = printed_copy_number

    def add_copy_date(self, copy_date):
        self[u'copy_date'] = copy_date

    def add_published_date(self, published_date):
        self[u'published_date'] = published_date

    def add_legislation_type(self, legislation_type):
        self[u'legislation_type'] = legislation_type

    def add_interested_party(self, interested_party):
        self[u'interested_party'] = interested_party

    def add_summary(self, summary):
        self[u'summary'] = summary

    def add_authors_by_obj(self, authors):
        self[u'authors'] = authors

    def add_source_url(self, source_url):
        self[u'source_url'] = source_url

    def add_attachment_by_obj(self, attachment):
        if u'document' not in self:
            self[u'document'] = ''
            if isinstance(attachment, DocumentAttachment):
                self[u'document'] = attachment.to_json()
            else:
